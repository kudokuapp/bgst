...
export default async function handler(
   ...
   * For BCA, the maximum is 3 months back,
   * so we pull 2 months
   *
   * For example: if the user start connecting their BGST account
   * at 9 February 2023, the maximum data we can get is
   * 9 November 2022 (3 months back). But since BGST is monthly basis,
   * we will pull transaction from 1 Desember 2022.
   */
