...
import { fetchDetails } from 'app/account/connect/bca/detail/[accessToken]/[userId]/[institutionId]/fetchdetails';
...
export default async function Page({
  ...
  fetchDetails({
    ...
    .then((data: any) => {
      redirect(`/account/connect/mandiri/transaction/${data.id}`);
    })
    .catch(() => {
