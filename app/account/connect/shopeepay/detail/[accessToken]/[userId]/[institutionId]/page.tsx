...
import { fetchDetailsEWallet } from 'app/account/connect/gopay/detail/[accessToken]/[userId]/[institutionId]/fetchdetailewallet';
...
export default async function Page({
  ...
  fetchDetailsEWallet({
    ...
    .then((data: any) => {
      redirect(`/account/connect/shopeepay/transaction/${data.id}`);
    })
    .catch(() => {
